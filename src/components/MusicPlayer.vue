...
onMounted(() => {
    ...
    if(currentTrack.value){
        ...
        seekerContainer.value?.addEventListener('click', function(e: MouseEvent){
    ...
    >
        <div class="flex items-center w-1/4">
            <div class="flex items-center ml-4">
                <img class="rounded-sm shadow-2xl" width="55" :src="currentArtist.albumCover" alt="Imagem do albúm">
                <div class="ml-4">
